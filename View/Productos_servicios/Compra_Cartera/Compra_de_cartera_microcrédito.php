...
<head>
  ...
  <title>Compra de cartera de microcrédito.</title>
...
<div class="porque">
  <div class="texto-encabezado">
    <h1>SOLICITA TU COMPRA DE CARTERA DE MICROCRÉDITO HOY <br> CON NOSOTROS TU AMIGO Y BANCO DE CONFIANZA</h1>
  </div>
  <div class="imagen-encabezado">
    <img src="<?= BASE_URL ?>/View/public/assets/Img/Creditos/Y1.png" alt="Imagen crédito" floatr="right">
  </div>
</div>
...
<center><img src="<?= BASE_URL ?>/View/public/assets/Img/Creditos/a1.png" alt=""></center>
      <h3>¿Qué es una Compra de cartera de microcrédito?</h3>
      <p>Es un producto financiero que permite trasladar microcréditos activos (pequeños préstamos otorgados generalmente para actividades productivas o emprendimientos) desde una entidad financiera actual hacia otra.</p>
    </div>
    ...
    <li>Carta de saldo del microcrédito vigente (saldo total, entidad, condiciones).</li>
    <li>Certificado de ingresos (puede ser informal, validado por asesor o firmada por contador).</li>
    <li>Certificación de actividad económica (puede ser una declaración juramentada).</li>
    <li>Extractos bancarios o registros de movimientos (si aplica).</li>
    <li>Referencias personales o comerciales.</li>
      </ul>
    </div>
  </section>
