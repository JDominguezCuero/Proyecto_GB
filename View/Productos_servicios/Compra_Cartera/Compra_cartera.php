...
<div class="panel">
  <div class="panel-texto">
    <h1>Credito De Compra De Cartera</h1>
  </div>
...
<div class="card-container">
  ...
  <div class="card">
    ...
    <div class="card-content">
      <h3>Compra de cartera crédito de vehículo</h3>
...
<p>Similar a la anterior, pero incluye la posibilidad de trasladar contratos de leasing habitacional.</p>      </div>
      <div class="card-button">
        <a href="../Creditos_Hipotecarios_y_de_Vivienda/Compra_de_Cartera_de_Vivienda.php">Saber más <span>→</span></a>
      </div>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-content">
      ...
      <p>Es la opción para personas que desean unificar diferentes tipos de créditos personales (hipotecario, consumo, libranza, etc.) en una sola entidad con mejores condiciones.</p>
    </div>
    <div class="card-button">
