...
<head>
  ...
  <title>Compra de cartera de crédito rotativo</title>
...
<div class="porque">
  <div class="texto-encabezado">
    <h1>SOLICITA TU COMPRA DE CARTERA DE CREDITO ROTATIVO HOY <br> CON NOSOTROS TU AMIGO Y BANCO DE CONFIANZA</h1>
  </div>
  <div class="imagen-encabezado">
    <img src="<?= BASE_URL ?>/View/public/assets/Img/Creditos/Y8.png" alt="Imagen crédito" floatr="right">
  </div>
</div>
...
<center><img src="<?= BASE_URL ?>/View/public/assets/Img/Creditos/a1.png" alt=""></center>
      <h3>¿Qué es una Compra de cartera de crédito rotativo?</h3>
      <p>Es un préstamo que te permite trasladar las deudas de un crédito rotativo (como tarjetas de créditos o cupos de libre uso) a otro banco o entidad financiera, con mejores tasas de interés y condiciones de pago.</p>
    </div>
    <div class="info-box">
    ...
    <li>Carta de saldo de la entidad financiera donde tienes el crédito rotativo.</li>
    <li>Extractos recientes del crédito rotativo.</li>
