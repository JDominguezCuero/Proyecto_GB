...
<body>
  ...
  <main class="options-container">
    ...
    <a href="<?= BASE_URL ?>/View/Productos_servicios/Compra_Cartera/Compra_cartera.php" class="option-card"><span class="icon">💳</span><h2>Credito De Compra De Cartera</h2></a>
      ...
      <form id="turnoForm" action="<?= BASE_URL ?>/Controlador/asesorController.php?accion=registrarTurno&accionesPublicas=crearTurnoPublico" method="POST">
        ...
        <div class="form-group">
            ...
            <select id="producto_interes" name="producto_interes">
                <option value="50">Ninguno - Pedir asesoría.</option>
                ...
                <option value="41">Crédito De Vivienda</option>
            </select>
        </div>
